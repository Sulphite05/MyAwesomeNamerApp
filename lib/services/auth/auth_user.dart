...
class AuthUser {
  ...
  factory AuthUser.fromFirebase(User user) => AuthUser(isEmailVerified: user.emailVerified);  // factory method and fromFirebase need a user as arg to return emailVerified
}
